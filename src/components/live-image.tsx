...
const URL = `wss://110602490-lcm-plexed-sd15-i2i.gateway.alpha.fal.ai/ws?fal_key_id=${process.env.NEXT_PUBLIC_FAL_KEY_ID}&fal_key_secret=${process.env.NEXT_PUBLIC_FAL_KEY_SECRET}`;
